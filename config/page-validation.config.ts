...
export const defaultConfig: PageValidationConfig = {
  ...
  seoDefaults: {
    ...
    openGraph: {
      required: true,
      expectedTags: ["og:title", "og:description", "og:url", "og:image"],
    },
    twitter: {
      required: true,
      expectedTags: ["twitter:card", "twitter:title", "twitter:description", "twitter:image"],
    },
  },
  headerDefaults: {
    required: true,
    headerSelector: "header",
    logoSelector: "header a.logo, header .logo-container",
    logoImageSelector: "header a.logo img, header .logo-container img",
    logoLinkSelector: "header a.logo, header .logo-container a",
    navSelector: "header nav",
    learnButtonSelector: "header button:has-text('Learn')",
    megaMenuSelector: "[data-testid='mega-menu'], .mega-menu-drawer",
  ...
  footerDefaults: {
    ...
    sectionSelectors: ["footer .footer-section", "footer nav section"],
    ...
    languageSelector: {
      required: true,
      selector: "footer .language-selector select",
      applyButtonSelector: "footer .language-selector button.apply",
      testLocale: "es",
